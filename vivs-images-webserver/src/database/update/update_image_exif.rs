...
pub async fn execute_update_image_exif_sql(exif: &ImageExif, pool: &Pool<Sqlite>) -> actix_web::Result<()> {
...
pub async fn execute_insert_image_exif_sql(exif: ImageExif, pool: Pool<Sqlite>) -> actix_web::Result<()> {
...
pub async fn execute_delete_image_exif_sql(image_path: &String, pool: &Pool<Sqlite>) -> actix_web::Result<()> {
