...
#[async_trait]
impl AnalysisTaskItemProcessor<Arc<FilePathComparisonModel>, String, Arc<ImageExif>> for ExifProcessor {
...
pub type InsertNewExifsOrchestratorAction = AnalysisTaskItemProcessorOrchestrator<Arc<FilePathComparisonModel>, String, Arc<ImageExif>>;
